...
// Endpoint kecil untuk menerima POST JSON (action=manual) dan mengembalikan JSON murni.

// Sesuaikan path db.php jika berbeda
...
// enable simple debug when needed (set false di produksi)
$debug = false;
